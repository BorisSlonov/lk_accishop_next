...
function ConfirmationError() {
  return (
    <p>
      На вашу почту отправлено письмо, перейдите по ссылке из него для подтверждения регистрации. Еще не получили письмо?{' '}
...
export default function SignInForm() {
  ...
  const hasConfirmationError =
    errors.strapiError === 'Для входа подтвердите почту, перейдя по ссылке из письма';
